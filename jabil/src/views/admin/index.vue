<template>
  <div class="app-container">
    <div class="filter-container" style="margin-bottom: 20px">
      ...
      <el-select v-model="listQuery.position" placeholder="职位" clearable style="width: 190px" class="filter-item">
        <el-option v-for="item in positionOptions" :key="item" :label="item" :value="item" />
      </el-select>
      <el-select v-model="listQuery.dept" placeholder="部门" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in deptOptions" :key="item.key" :label="item" :value="item" />
      </el-select>
...
<script>
import { fetchList, createArticle, updateArticle } from '@/api/admin'
...
export default {
  ...
  data() {
    return {
      ...
      positionOptions: ['系统管理员', 'Workcell经理', '初级用户', '高级用户', '	监管员'],
      sortOptions: [{ label: 'ID 升序', key: '+id' }, { label: 'ID 降序', key: '-id' }],
      deptOptions: ['工程部', '生产部', '质量部', '测试部'],
      showReviewer: false,
      temp: {},
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['ID', '姓名', '职位', '部门', '邮箱']
        const filterVal = ['id', 'name', 'position', 'dept', 'email']
